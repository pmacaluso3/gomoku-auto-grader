...
public class Gomoku {
    ...
    public static final String OFF_BOARD_MESSAGE = "Stone is off the board.";

    public static final String DUPLICATE_MOVE_MESSAGE = "Duplicate move.";
    ...
    public static Gomoku createGomokuInstance(Player playerOne, Player playerTwo) {
        Gomoku gomoku = new Gomoku(playerOne, playerTwo);
        instance = gomoku;
        return gomoku;
    }

    public static Gomoku getInstance() { return instance; }
    ...
    public Result place(Stone stone) {
        ...
        if (!isValid(stone)) {
            return new Result(OFF_BOARD_MESSAGE);
        }
        ...
        if (board[stone.getRow()][stone.getColumn()] != 0) {
            return new Result(DUPLICATE_MOVE_MESSAGE);
        }
    ...
    private Gomoku(Player playerOne, Player playerTwo) {
